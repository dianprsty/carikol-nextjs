    ...
    <>
        ...
        <div className="grid grid-cols-1 gap-8 mx-auto w-full max-w-6xl md:grid-cols-4">
          ...
          <div className="space-y-4">
            ...
            <div className="mt-4 space-y-1">
              ...
              <div className="flex items-center gap-2 text-gray-600">
                ...
                <a href="mailto:support@carikol.id" className="hover:text-teal-600">
                  support@carikol.id
                </a>
              </div>
              <div className="flex items-center gap-2 text-gray-600">
          ...
          <div className="space-y-2">
            ...
            {[
              ...
              <Link href="#" key={idx} className="text-gray-600 hover:text-teal-600">
                {item}
              </Link>
            ))}
          </div>
          ...
          <div className="space-y-2">
            ...
            {[
              ...
              <Link href={link.href} key={idx} className="text-gray-600 hover:text-teal-600">
                {link.text}
              </Link>
            ))}
          </div>
      ...
      <div className="p-4 bg-white border-t text-center border-gray-200">
        <div className="max-w-6xl mx-auto flex justify-center gap-6 mb-2">
          {/* Media sosial (contoh: Instagram, YouTube, Threads) */}
          {[
            {
              name: "Instagram",
              svg: (
